package com.mrtuovinen.skilldemon.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "skilldemon@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "skilldemon API";

        private String description = "skilldemon API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "skilldemon";
